...
class ViewController: UIViewController {
    ...
    private var imageTestArray = [UIImage]()
    ...
    func runModel(onPixelBuffer pixelBuffer: CVPixelBuffer) {
        ...
        chekResultAndTakeShot(results: displayResult, captureSession: self.captureSession)
    ...
    func chekResultAndTakeShot (results:Result, captureSession: AVCaptureSession) {
        ...
        DispatchQueue.main.async {
            self.capturePhoto()
            print("Photo after:", self.imageTestArray.count)
...
//MARK:- Methods of protocol and delegat
    func photoOutput(_ output: AVCapturePhotoOutput, didFinishProcessingPhoto photo: AVCapturePhoto, error: Error?) {
        ...
        self.imageTestArray.insert(image, at: 0)
          }
